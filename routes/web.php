...
Route::match(['get','post'],'admin/session','AdminController@session')->name('admin.session');

Route::match(['get','post'],'admin/level','AdminController@level')->name('admin.level');

Route::match(['get','post'],'admin/class','AdminController@klass')->name('admin.class');

Route::match(['get','post'],'admin/subject','AdminController@subject')->name('admin.subject');

//register the students
Route::match(['get','post'],'admin/registerstudents','AdminController@registerstudents')->name('admin.registerstudents');
...
Route::match(['get','post'],'admin/editprofile','AdminController@admineditprofile')->name('admin.editprofile');

//teachers
Route::match(['get','post'],'admin/registerteachers','AdminController@registerteachers')->name('admin.registerteachers');
...
Route::group(['prefix' => 'student','namespace'=>"Student"], function() {
	...
	Route::match(['GET','POST'],'/initate_school_fees_payment','SchoolFeesController@initiate')->name('initate_school_fees_payment');

    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Enter Student Details: <small>fill the (current and correct) details to register</small>
                        </h2>
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" action="/admin/registerstudents" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Term<span
                                        class="required">*</span></label>
                                <div class="col-md-8 col-sm-6 col-xs-12">

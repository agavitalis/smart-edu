        ...
        <div class="row">
                        ...
                        <div class="x_content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="checkbox"  name="student[]" id="hobby2" value="{{$user->id}}"
                                                class="flat" /> Select Student
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                    ...
                                    <button type="submit" class="btn btn-success">Promote or Demote to this
                                        Level</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left input_mask" action="/admin/givestudentslevel"
                            method="post">
                            {{csrf_field()}}

    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Enter Teacher's Details: <small>fill the (current and correct) details to register</small>
                        </h2>
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" action="/admin/registerteachers" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="regno">Registration Number
                        ...
                        <div class="container">
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    <h3>Teacher Registration Sample File:</h3>
                                    <div style="border: 2px solid #a1a1a1;margin-top: 15px;padding: 20px;">

                                        <a href="{{ url('downloadTeacher/xlsx') }}"><button
                                    ...
                                    <form style="border: 2px solid #a1a1a1;margin-top: 15px;padding: 20px;"
                                        action="{{ URL::to('importteacher') }}" class="form-horizontal" method="post"

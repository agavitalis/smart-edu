        ...
        <div class="animate form login_form col-md-12 col-sm-12 col-xs-12">
          <section class="login_content">
            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
              ...
              <div>
                <input id="username" type="text" class="form-control" name="username" value="{{ old('username') }}" placeholder="Reg Number" required autofocus>
              ...
              <div class="separator">
                ...
                <br />
                 ...
                 <div>
                  ...
                  <p>©<?php echo date('Y'); ?> All Rights Reserved. Powered by Vivvaa.</p>
                </div>
              </div>
            </form>
          </section>

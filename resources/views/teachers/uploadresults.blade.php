                        ...
                        <div class="container">
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    ...
                                    <h3>Download Sample Result Sheet:</h3>
                                    <div
                                        style="border: 1px solid #a1a1a1;margin-top: 15px;padding: 20px; text-align:center">

                                        <a href="{{ url('resultsheet/xlsx') }}"><button
                                                class="btn btn-success btn-block">Download Sample Upload File
                                                xlsx</button></a>
                        ...
                        <div class="container">
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    ...
                                    <form
                                        style="border: 1px solid #a1a1a1;margin-top: 15px;padding: 20px; text-align:center"
                                        action="{{ URL::to('tutor/uploadresults') }}" class="form-horizontal"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Select File<span
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Subject<span
                                                    class="required">*</span></label>
                                            <div class="col-md-8 col-sm-6 col-xs-12">
                                                <select class="form-control" required="" name="subject">
                                                    ...
                                                    <option value="{{$subject->name}}">
                                                        {{$subject->name ." ".$subject->level }}</option>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Class<span
                                                    class="required">*</span></label>
                                            <div class="col-md-8 col-sm-6 col-xs-12">

...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-clone"></i>Manage Fees<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="/admin/set_school_fees">Set School Fees</a></li>
                    <li><a href="/admin/school_fees_logs">View Payment Logs</a></li>
                </ul>
            </li>
